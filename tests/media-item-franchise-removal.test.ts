...
const seriesActionsSource = readFileSync("src/app/archive/archive-series-actions.ts", "utf8");
const seriesSearchSource = readFileSync("src/app/archive/archive-series-media-link-search.tsx", "utf8");
