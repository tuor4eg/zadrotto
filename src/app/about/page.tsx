    ...
    <main className="archive-page min-h-screen px-3 pb-3 pt-3 text-stone-950 sm:px-5 sm:pb-5 lg:px-7 lg:pb-7">
      <div className="mx-auto flex w-full max-w-[1480px] flex-col gap-3">
            ...
            <div>
              ...
              <div className="mt-6 space-y-4 text-base leading-7 text-stone-700">
                <p>
                  ...
                  темы, подборки и серии. Со временем из этой базы могут вырасти эссе и выпуски того
        ...
        <section className="archive-paper archive-panel p-5 sm:p-6">
          ...
          <p className="mt-3 text-sm leading-6 text-stone-600">
            Все изображения созданы с помощью нейросетей. Если когда-нибудь в нашей команде появится настоящий мясной художник, то он, конечно, сделает с душой. Но пока бездушная железяка тоже справляется.
          </p>
        </section>
