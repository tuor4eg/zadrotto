              ...
              >
                <div className="min-w-0">
                  ...
                  {series.originalTitle && series.originalTitle !== series.title ? (
                    <p className="mt-1 break-words font-mono text-[0.7rem] uppercase tracking-[0.1em] text-stone-500">
                      {series.originalTitle}
                    </p>
                  ) : null}
                </div>
                <p className="shrink-0 font-mono text-xs uppercase tracking-[0.12em] text-stone-600">
