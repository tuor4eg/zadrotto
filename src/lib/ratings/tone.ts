...
export const AVERAGE_BOOK_NOTE_RATING_TONE_CLASS_NAMES: Record<RatingTone, string> = {
  bad: "text-red-800",
  medium: "text-blue-950",
  good: "text-emerald-800",
};

export const AUTHOR_BOOK_NOTE_RATING_TONE_CLASS_NAMES: Record<RatingTone, string> = {
  bad: "text-red-700",
  medium: "text-blue-950",
  good: "text-emerald-700",
};
...
export const AVERAGE_ROBLOX_RATING_TONE_CLASS_NAMES: Record<RatingTone, string> = {
  bad: "text-red-700",
  medium: "text-sky-700",
  good: "text-emerald-700",
};

export const AUTHOR_ROBLOX_RATING_TONE_CLASS_NAMES: Record<RatingTone, string> = {
  bad: "text-red-200",
  medium: "text-blue-100",
